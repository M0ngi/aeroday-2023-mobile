...
class PercentageCircle extends Component<IPercentageCircle, any> {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <View style={[{...styles.circle, ...(this.props.style as Object ?? {})},{
        width:this.props.radius*2,
        height: this.props.radius*2,
        borderRadius:this.props.radius,
        backgroundColor: this.props.bgcolor ?? Colors.background,
        transform: [{
        ...
        <View style={[styles.innerCircle,{
              ...
              backgroundColor: this.props.innerColor ?? Colors.background,
            }]}>
